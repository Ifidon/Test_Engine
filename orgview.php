            ...
            <table class="table table-center table-bordered table-striped" id="testtable">
              ...
              <tbody>
                ...
                foreach($tests as $test) {
                  ...
                  echo("<td class='small'><a href='edit.php?test=".urlencode($test['test_id'])."&edit=True'>Edit</a> / <a href='delete.php?test=".urlencode($test['test_id'])."&delete=True'>Delete</a> / <a href='viewtest.php?test=".urlencode($test['test_id'])."' target='_blank'>Generate Test</a> / <a href='reset.php?test=".urlencode($test['test_id'])."' target='_blank'>Reset Test</a></td>");
                  echo("</tr>");
                }
                ?>
              </tbody>
